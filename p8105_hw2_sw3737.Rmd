...
The Trash Wheel dataset consists of observations from three unique Trash Wheels: Mr. Trash Wheel, Professor Trash Wheel, and Gwynnda. The combined dataset has a total of `845 observations` and `15 variables`, capturing various attributes, including `wheel_name`, `dumpster`, `month`, `year`, `date`, `weight_tons`, `volume_cubic_yard`, `plastic_bottles`, `polystyrene`, `cigarette_butts`, `glass_bottles`, `plastic_bags`, `wrappers`, `sports_balls`, and `home_powered`. A total weight of `216.26 tons of trash` was collected by Professor Trash Wheel. Gwynnda collected a total of `1.63^{4} cigarette butts` in July of 2021.
